...
configuration : PTHA scenario
===========================================

setrun for Sulawesi scenario:
...
# ===============================================================
    ...
    INPUT : claw_pkg expected to be "geoclaw" for this setrun.
    OUTPUT: rundata - object of class ClawRunData
    """
    ...
    if clawdata.output_style==1:
        ...
        TMID = 600.
        TFINAL = 3600.*2.5
        clawdata.output_times = [2.] + [float(x) for x in np.linspace(TMID,TFINAL,15)]
    ...
    # ================================================================
    # (10) AMR parameters:   (written to amr.data)
    # ================================================================
...
def setgeo_fine(rundata):
    ...
    for fgfile in ['fgmax1_fine.txt', 'fgmax2_fine.txt', 'fgmax3_fine.txt']:
        ...
        fg.read_fgmax_grids_data(os.path.join(os.getcwd(), fgfile))
